...
/*Update(2024-08-26) 신뢰성검사 : task -> task->arg 변경함 */
...
/*Update(2024-08-26) 신뢰성검사 : task_exit 함수가 사용되지 않음  */
/*
...
/*Update(2024-08-26) 신뢰성검사 : task_event 함수가 사용되지 않음  */
/*Update(2024-08-26) 신뢰성검사 : identifier sigval는 상위 scope에 존재하는 동일한 identifier를 가림 signal -> signal_value */
/*
...
/*Update(2024-08-26) 신뢰성검사 : task_event_ptr 함수가 사용되지 않음  */
/*Update(2024-08-26) 신뢰성검사 : identifier sigval는 상위 scope에 존재하는 동일한 identifier를 가림 signal -> signal_value */
/*
...
/*Update(2024-08-26) 신뢰성검사 : identifier callback는 상위 scope에 존재하는 동일한 identifier를 가림 callback -> p_callback */
/*Update(2024-08-26) 신뢰성검사 : timer_create2 함수가 사용되지 않음 */
/*
